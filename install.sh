...
generate_xray_config() {
  ...
  touch /etc/vpn-script/db/sshws.db
...
install_script_files() {
  ...
  # NOTE: "sshws" dan "update" WAJIB ada di list ini, karena menu.sh
  # (opsi [3] SSH WebSocket dan [8] Update Script) memanggil keduanya.
  for f in vmess vless nginx dropbear sysinfo changedomain sshws update uninstall; do
