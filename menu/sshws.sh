...
sshws_header() {
  ...
  echo -e "  ${PURPLE}SSH-SSL       ${NC}: port ${WHITE}$STUNNEL_SSL_PORT${NC}"
  echo -e "  ${PURPLE}SSH-SSL       ${NC}: port ${WHITE}${HAPROXY_SSL_PORT:-444}${NC}"
  echo -e "  ${PURPLE}SSH-WS nTLS   ${NC}: port ${WHITE}80${NC}"
  echo -e "  ${PURPLE}SSH-WS nTLS   ${NC}: port ${WHITE}8880${NC}"
  echo -e "  ${PURPLE}SSH-WS nTLS   ${NC}: port ${WHITE}8080${NC}"
  echo -e "  ${PURPLE}SSH-WS nTLS   ${NC}: port ${WHITE}2080${NC}"
  echo -e "  ${PURPLE}SSH-WS nTLS   ${NC}: port ${WHITE}2082${NC}"
  echo -e "  ${PURPLE}SSH-WS TLS    ${NC}: port ${WHITE}443${NC}"
